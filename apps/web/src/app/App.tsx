...
export function App() {
  ...
  const sendGroup=(body:string,agentId:string)=> data ? perform(`/groups/${data.thread.id}/messages`,{body,agent_id:agentId}) : Promise.resolve(false);
